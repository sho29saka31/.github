...
問題が発生した場合は、速やかに報告することが重要です。本行動規範に反する可能性のある行為については、公開の Issue を作成せず、[SECURITY.md](SECURITY.md) に記載の Private vulnerability reporting、またはリポジトリオーナーの [GitHub プロフィール](https://github.com/sho29saka31) 経由で報告してください。
